...
$Vendor = "Misc"
$Product = "BitwardenDesktopClient"
$PackageName = "BitwardenDesktop"
$Evergreen = Get-EvergreenApp -Name BitwardenDesktop
$Version = "1.25.1"
$URL = "https://github.com/bitwarden/desktop/releases/download/v1.25.1/Bitwarden-Installer-1.25.1.exe"
$InstallerType = "exe"
